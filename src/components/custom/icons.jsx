...
export const LogoGoogle = ({ size = 16 }) => {
  return (
    <svg height={size} viewBox="0 0 24 24" width={size} style={{ color: 'currentcolor' }}>
      <path
        d="M21.35 11.1H12v2.8h5.35c-.25 1.4-1.05 2.6-2.2 3.35v2.75h3.55c2.05-1.9 3.25-4.7 3.25-8.1 0-.65-.05-1.3-.15-1.9z"
        fill="#4285F4"
      />
      <path
        d="M12 22c2.7 0 4.95-.9 6.6-2.45l-3.55-2.75c-.95.65-2.15 1.05-3.55 1.05-2.75 0-5.05-1.85-5.85-4.35H2.05v2.75C3.7 19.85 7.55 22 12 22z"
        fill="#34A853"
      />
      <path
        d="M6.15 13.5c-.25-.65-.4-1.35-.4-2.1s.15-1.45.4-2.1V6.55H2.05C1.35 8.05 1 9.5 1 11s.35 2.95 1.05 4.45l4.1-2.95z"
        fill="#FBBC05"
      />
      <path
        d="M12 4.5c1.5 0 2.85.5 3.9 1.45l2.9-2.9C16.95 1.35 14.7.5 12 .5 7.55.5 3.7 2.65 2.05 6.55l4.1 2.75c.8-2.5 3.1-4.35 5.85-4.35z"
        fill="#EA4335"
      />
    </svg>
  )
