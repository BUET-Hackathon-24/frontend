...
function BlockOptionsDropdownList({ editor, blockType, toolbarRef, setShowBlockOptionsDropDown }) {
  ...
  return (
    ...
    >
      ...
      <ListItem selected={blockType === 'quote'} className="rounded-md py-2" onClick={formatQuote}>
        <ListItemPrefix>
          <svg
            className="h-5 w-5"
            strokeWidth="1.5"
      ...
      <ListItem selected={blockType === 'code'} className="rounded-md py-2" onClick={formatCode}>
        <ListItemPrefix>
          <svg
            strokeWidth="1.5"
            viewBox="0 0 24 24"
...
function ToolbarPlugin() {
  ...
  return (
    <div className="m-1 flex items-center gap-0.5 rounded-lg bg-gray-100 p-1" ref={toolbarRef}>
